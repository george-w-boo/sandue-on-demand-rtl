...
function hasPointerEvents(config, element) {
  var _a;
  return ((_a = checkPointerEvents(config, element)) == null ? void 0 : _a.pointerEvents) !== "none";
}
...
function commitValueAfterInput(element, cursorOffset) {
  ...
  if (!((_a = changes == null ? void 0 : changes.tracked) == null ? void 0 : _a.length)) {
    return;
  }
...
function unhover(element) {
  return __async(this, null, function* () {
    assertPointerEvents(this[Config], this[Config].pointerState.position.mouse.target);
  ...
  return __async(this, null, function* () {
    ...
    if (isElementType(select, "select")) {
      if (select.multiple) {
        ...
        const withPointerEvents = this[Config].pointerEventsCheck === 0 ? true : hasPointerEvents(this[Config], select);
        if (withPointerEvents) {
